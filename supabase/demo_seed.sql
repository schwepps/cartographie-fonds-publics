...
insert into entities (siren, name, level, category, parent_siren, provenance) values
  ('402360441', 'Société Helios Numérique', 'delegated', 'Marché public', null, 'decp'),
  ('440048882', 'Atlas Édition scientifique', 'delegated', 'Marché public', null, 'decp'),
  ('552032534', 'EnerGaïa Énergies', 'delegated', 'Concession', null, 'decp'),
  ('552081317', 'Groupe Demeter (BTP patrimoine)', 'delegated', 'Concession', null, 'decp'),
  ('552100554', 'Société Restalia (restauration collective)', 'delegated', 'Délégation de service public', null, 'decp'),
  ('200053781', 'Métropole de Lyon', 'local', 'Métropole', null, 'ofgl'),
  ('200054807', 'Région Auvergne-Rhône-Alpes', 'local', 'Région', null, 'ofgl'),
  ('217500016', 'Ville de Paris', 'local', 'Commune', null, 'ofgl'),
  ('225900019', 'Département du Nord', 'local', 'Département', null, 'ofgl'),
  ('237500139', 'Région Île-de-France', 'local', 'Région', null, 'ofgl'),
  ('243300316', 'Bordeaux Métropole', 'local', 'Métropole', null, 'ofgl'),
  ('180020075', 'Caisse nationale des allocations familiales', 'social', 'Caisse nationale', null, 'comptes_secu'),
  ('180035024', 'Caisse nationale de l’assurance maladie', 'social', 'Caisse nationale', null, 'comptes_secu'),
  ('180035040', 'Urssaf Caisse nationale', 'social', 'Caisse nationale', null, 'comptes_secu'),
  ('180090094', 'Caisse centrale de la Mutualité sociale agricole', 'social', 'Régime', null, 'comptes_secu'),
  ('301846688', 'Agirc-Arrco', 'social', 'Régime paritaire', null, 'comptes_secu'),
  ('775678633', 'Caisse nationale d’assurance vieillesse', 'social', 'Caisse nationale', null, 'comptes_secu'),
...
insert into edges (source_siren, target_siren, type, amount_eur, exercice, provenance) values
  ...
  ('130005481', '402360441', 'delegates', 19000000, 2026, 'decp'),
  ('180035024', '180036048', 'participation', 240000000, 2024, 'comptes_secu'),
  ('180043016', '552081317', 'delegates', 48000000, 2026, 'decp'),
  ('180046096', '552081317', 'delegates', 16000000, 2026, 'decp'),
  ('180046252', '440048882', 'delegates', 4200000, 2026, 'decp'),
  ('180089013', '326556578', 'delegates', 85000, 2026, 'decp'),
  ('180089013', '329200521', 'delegates', 1800000, 2026, 'decp'),
  ('200053781', '130031023', 'funds', 12000000, 2024, 'ofgl'),
  ('217500016', '775670387', 'funds', 9000000, 2024, 'ofgl'),
  ('217500016', '784359069', 'funds', 7000000, 2024, 'ofgl'),
  ('237500139', '193100339', 'funds', 64000000, 2024, 'ofgl'),
  ('237500139', '197517177', 'funds', 88000000, 2024, 'ofgl'),
  ('301846688', '130005481', 'participation', 4000000000, 2024, 'comptes_secu'),
  ('775685019', '552032534', 'delegates', 64000000, 2026, 'decp'),
  ('784359069', '552100554', 'delegates', 22000000, 2026, 'decp');
...
insert into budget_facts (entity_siren, exercice, mission, programme, amount_ae_eur, amount_cp_eur, executed, provenance) values
  ('110044013', 2025, 'MIRES', '150 — Formations supérieures et recherche universitaire', 15217000000, 15279000000, false, 'budget_plf_lfi'),
  ('110044013', 2025, 'MIRES', '172 — Recherches scientifiques et technologiques pluridisciplinaires', 8259807441, 8701105312, false, 'budget_plf_lfi'),
  ('110044013', 2025, 'MIRES', '193 — Recherche spatiale', 2100000000, 2100000000, false, 'budget_plf_lfi'),
  ('110044013', 2024, 'MIRES', '150 — Formations supérieures et recherche universitaire', 14690000000, 14710000000, true, 'budget_plf_lfi'),
  ('110044013', 2024, 'MIRES', '172 — Recherches scientifiques et technologiques pluridisciplinaires', 7980000000, 8120000000, true, 'budget_plf_lfi'),
  ('110046018', 2025, 'Culture', '175 — Patrimoines', 1240000000, 1190000000, false, 'budget_plf_lfi'),
  ('110046018', 2025, 'Culture', '131 — Création', 1010000000, 990000000, false, 'budget_plf_lfi'),
  ('110046018', 2025, 'Culture', '224 — Soutien aux politiques culturelles', 780000000, 760000000, false, 'budget_plf_lfi'),
  ('110000072', 2025, 'Travail et emploi', '102 — Accès et retour à l’emploi', 7100000000, 6980000000, false, 'budget_plf_lfi'),
