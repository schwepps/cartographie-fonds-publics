...
/**
 * Icon set — simple 24×24 stroke glyphs (Remix-style), ported from the `design/` export
 * (`js/icons.jsx`). Decorative by default (`aria-hidden`); a meaningful icon should be labelled by
 * its surrounding control (e.g. an icon-only button's `aria-label`). Any attribute — size, `aria-*`,
 * `className` — can be overridden per use via props.
 */
...
export const Graph = makeIcon(
  <>
    <circle cx="5" cy="6" r="2.4" />
    <circle cx="19" cy="7" r="2.4" />
    <circle cx="12" cy="18" r="2.4" />
    <path d="M7.1 7.1l3 8M16.8 8.6l-3.6 7.6M7 6.6h9.6" />
  </>,
);
...
export const Flow = makeIcon(
  <>
    <path d="M4 6h6c4 0 4 12 10 12" />
    <path d="M4 18h6" />
...
export const ArrowUp = makeIcon(<path d="M12 19V5M6 11l6-6 6 6" />);
export const ArrowDown = makeIcon(<path d="M12 5v14M6 13l6 6 6-6" />);
...
export const Filter = makeIcon(<path d="M3 5h18l-7 8v5l-4 2v-7z" />);
...
export const Check = makeIcon(<path d="M5 12l5 5L20 6" />);
...
export const Chevron = makeIcon(<path d="M9 6l6 6-6 6" />);

/** Name → component map, for data-driven lookups (e.g. the registry-driven nav). */
export const Icons = {
  Search,
  Graph,
  Home,
